...
using GamingOceanTcg.Models.DTOs;
...
{
    private GamingOceanTcgDbContext _dbContext;
    private UserManager<IdentityUser> _userManager;

    public AuthController(GamingOceanTcgDbContext context, UserManager<IdentityUser> userManager)
    {
        _dbContext = context;
